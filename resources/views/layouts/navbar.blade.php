<div class="navbar bg-base-100 shadow-lg">
  ...
  <div class="flex-1 md:hidden">
    <div class="dropdown">
      ...
      <ul tabindex="0" class="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
        <li><a href="{{ route('home') }}">Aurora</a></li>
  ...
  <div class="flex-1 hidden md:flex space-x-4">
    <a href="{{ route('home') }}" class="btn btn-ghost btn-sm">Aurora</a>
    <a href="{{ route('home') }}" class="btn btn-ghost btn-sm">Servicios</a>
    <a href="{{ route('supplier.index') }}" class="btn btn-ghost btn-sm">Proveedor</a>
